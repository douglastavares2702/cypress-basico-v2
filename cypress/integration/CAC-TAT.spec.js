...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('campo telefone continua vazio se for digitado valor não-numérico', function() {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')     
            ...
            .should('have.value', '')  
        cy.get('#email')
            .type('datg2702@hotmail.com')
            .should('have.value', 'datg2702@hotmail.com')  
            .clear()
            .should('have.value', '') 
        cy.get('#phone')    
            .type('988632111')
            .should('have.value', '988632111')  
            .clear()
            .should('have.value', '') 
